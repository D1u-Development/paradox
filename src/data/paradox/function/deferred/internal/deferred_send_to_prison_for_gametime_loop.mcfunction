...
execute if data storage paradox:temp DeferredList[0] run function paradox:deferred/internal/deferred_send_to_prison_for_gametime_loop with storage paradox:temp DeferredList[-1]
